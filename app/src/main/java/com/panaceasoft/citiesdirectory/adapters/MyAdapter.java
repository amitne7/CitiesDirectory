...
public class MyAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private List<CustomRowInformation> mDataset;
    ...
    public MyAdapter(List<CustomRowInformation> myDataSet, RecyclerView recyclerView) {
        mDataset = myDataSet;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if(holder instanceof MyViewHolder){
            ((MyViewHolder)holder).title.setText(mDataset.get(position).getTitle());
        }else{
